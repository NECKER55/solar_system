...
![The solar system seen from the outside](docs/images/01-solar-system-overview.png)
...
<tr>
<td width="50%">
<img src="docs/images/05-body-info-menu.png" alt="Body info menu">
...
<td width="50%">
<img src="docs/images/04-asteroid-creator.png" alt="Asteroid creator panel">
<p align="center"><sub><b>Build an asteroid</b> — set mass, material and velocity, preview it, then throw it.</sub></p>
</td>
</tr>
<tr>
<td width="50%">
<img src="docs/images/02-asteroid-flyby.png" alt="Asteroid near a planet">
...
<td width="50%">
<img src="docs/images/03-asteroid-trajectory.png" alt="Curved asteroid trajectory">
